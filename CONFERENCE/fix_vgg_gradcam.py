...
# The updated code to inject
updated_gradcam_code = [
    ...
    "    ])\\n",
    "    \\n",
    "    # Initialize GradCAM with use_cuda argument if available\\n",
...
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        ...
        if "start_gradcam_manual" in source:
            cell['source'] = updated_gradcam_code
            found = True
            break
...
if not found:
    ...
    nb['cells'].append({
        ...
        "metadata": {},
        "outputs": [],
        "source": updated_gradcam_code
    })

with open(nb_path, 'w', encoding='utf-8') as f:
    json.dump(nb, f, indent=2)

print(f"Updated Grad-CAM code in {nb_path} to fix device error.")
